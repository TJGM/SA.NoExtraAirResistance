...
For example, the Cheetah has a max speed of 197KMPH, but when driving in a cull zone with extra air resistance, the Cheetah can only reach a max speed of 161KMPH.
...
View the [mod page](https://tjgm.dev/mods/No-Extra-Air-Resistance/) for the full changelog, installation instructions and screenshots.
